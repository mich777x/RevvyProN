		...
		<section className="py-16">
			<div className="max-w-4xl mx-auto text-center">
				...
				<div className="flex justify-center gap-10 grayscale opacity-80">
					<img src="/logos/facebook.png" alt="Facebook Ads" className="h-10" />
					<img src="/logos/google.png" alt="Google Ads" className="h-10" />
					<img src="/logos/tiktok.png" alt="TikTok Ads" className="h-10" />
				</div>
			</div>
		</section>
	);
